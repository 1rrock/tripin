 ...
 * 웜 페이퍼: #f0e8db 지면, 잉크 타이포, 종류 라벨에 왁스(#c9441a) 밑줄 바. 사진 없음.
...
export default async function TypeOpengraphImage({
  ...
  const statsLine = `${placeCount}곳 · 도시 ${cityCount}`;
        ...
        {bold ? (
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "stretch" }}>
              <div style={{ display: "flex", fontSize: 96, fontWeight: 800, color: "#2a2118" }}>
                {label}
              </div>
