...
OWN-WORLD: 웜 페이퍼 지면 #f0e8db 위에 16:9 프레임이 놓인다. 잉크 #2a2118 가 제목과 인덱스, 왁스 연필 #c9441a 는 **표시에만** — 링·밑줄·활성 인덱스이지 버튼 배경이 아니다. 발광 금지. 라운드 4px, 따뜻한 오프셋 그림자, 아주 약한 종이 그레인. 페이퍼로지(한글 100~900) + Archivo(라틴·숫자 tabular).
