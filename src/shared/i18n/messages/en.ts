...
export const en: Messages = {
  ...
  apply: {
    ...
    errChannel: "Please check the YouTube channel URL.",
    ...
    takedownBefore: "You can take your channel down at any time via ",
    takedownLink: "removal request",
    takedownAfter: ".",
  },
  takedownForm: {
    heading: "Submit a request",
    lead: "Send it here and it lands in our queue right away.",
    mailAlt: "Prefer email? Write to {email} — same process, same timeline.",
    urlLabel: "Channel or place URL (optional)",
    urlPlaceholder: "https://eatripin.com/en/place/…",
    emailLabel: "Email for replies",
    emailPlaceholder: "you@example.com",
    emailHint: "The only way we can tell you the outcome. We don't use it for anything else.",
    reasonLabel: "Reason",
    reasonPlaceholder: "Tell us what's wrong, or why it should come down.",
    submit: "Send request",
    submitting: "Sending…",
    doneTitle: "Request received.",
    doneBody:
      "We'll review and act without delay, and email you the outcome. If something is temporarily unpublished, we decide within 30 days.",
    errEmail: "Please check your email address.",
    errReason: "Please tell us the reason.",
    errorInvalid: "Please check your email address and the reason.",
    errorRateLimited: "Too many requests. Please try again shortly.",
    errorFailed: "We couldn't record it. Email {email} instead — same process, same timeline.",
  },
  hub: {
    channelNav: "Channels",
  ...
  notFound: {
    ...
    body: "The link may have changed, been taken down, or never existed.",
