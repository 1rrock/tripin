...
export const Icon = {
  ...
  cup: glyph(
    <>
      <path d="M6.5 8.5h9.2v6.2a3.6 3.6 0 0 1-3.6 3.6H10a3.6 3.6 0 0 1-3.5-3.6V8.5Z" />
      <path d="M15.7 10.2h1.6a2.2 2.2 0 1 1 0 4.4h-1.6" />
      <path d="M7.2 20.2h9.6" />
    </>,
  ),
  /** 숙소 */
  bed: glyph(
    <>
      <path d="M3.6 18.5V9.8h7.4A4.2 4.2 0 0 1 15.2 14v4.5" />
      <path d="M3.6 14.2H20.4v4.3" />
      <path d="M3.6 18.5h16.8" />
    </>,
  ),
} as const;
